...
function getFallbackProjects(): BehanceProject[] {
    return [
        ...
        {
            id: 252450907,
            name: 'UCO.tn Social Media Design',
            published_on: Date.now() / 1000,
            created_on: Date.now() / 1000,
            modified_on: Date.now() / 1000,
            url: 'https://www.behance.net/gallery/252450907/Social-Media-Design',
            covers: {
                '404': '/images/projects/uco-social-thumb.svg',
                original: '/images/projects/uco-social-thumb.svg',
            },
            fields: ['Social Media', 'Graphic Design'],
            stats: {
                views: 0,
            ...
            description: 'A social media design series developed to strengthen UCO.tn\'s digital identity through clean visuals and impactful communication. Each post was crafted to educate, engage, and inspire a more sustainable lifestyle.',
            tags: ['social media', 'sustainability', 'recycling', 'visual identity'],
        },
        {
            id: 220774675,
